...
exports.toBase64Util = toBase64Util;
exports.toHexUtil = toHexUtil;
...
const hexNumbers = exports.hexNumbers = Array.from(Array(256).keys(), n => n.toString(16).padStart(2, "0"));
class Util {
...
var globalThis = __w_pdfjs_require__(4);
...
var isPossiblePrototype = __w_pdfjs_require__(73);
var $String = String;
var $TypeError = TypeError;
module.exports = function (argument) {
...
var toObject = __w_pdfjs_require__(39);
var lengthOfArrayLike = __w_pdfjs_require__(63);
var setArrayLength = __w_pdfjs_require__(85);
var doesNotExceedSafeInteger = __w_pdfjs_require__(87);
var fails = __w_pdfjs_require__(7);
...
var DESCRIPTORS = __w_pdfjs_require__(6);
var isArray = __w_pdfjs_require__(86);
var $TypeError = TypeError;
var getOwnPropertyDescriptor = Object.getOwnPropertyDescriptor;
...
var DESCRIPTORS = __w_pdfjs_require__(6);
var defineBuiltInAccessor = __w_pdfjs_require__(91);
var isDetached = __w_pdfjs_require__(111);
...
var globalThis = __w_pdfjs_require__(4);
var uncurryThis = __w_pdfjs_require__(96);
var arrayBufferByteLength = __w_pdfjs_require__(112);
...
var $ = __w_pdfjs_require__(3);
var $transfer = __w_pdfjs_require__(115);
if ($transfer)
 $({
  target: 'ArrayBuffer',
  proto: true
...
var uncurryThis = __w_pdfjs_require__(14);
var uncurryThisAccessor = __w_pdfjs_require__(71);
var toIndex = __w_pdfjs_require__(116);
var notDetached = __w_pdfjs_require__(117);
var arrayBufferByteLength = __w_pdfjs_require__(112);
var detachTransferable = __w_pdfjs_require__(118);
var PROPER_STRUCTURED_CLONE_TRANSFER = __w_pdfjs_require__(122);
...
var globalThis = __w_pdfjs_require__(4);
var getBuiltInNodeModule = __w_pdfjs_require__(119);
var PROPER_STRUCTURED_CLONE_TRANSFER = __w_pdfjs_require__(122);
var structuredClone = globalThis.structuredClone;
var $ArrayBuffer = globalThis.ArrayBuffer;
...
var ENVIRONMENT = __w_pdfjs_require__(121);
...
var uncurryThis = __w_pdfjs_require__(14);
var toString = __w_pdfjs_require__(77);
var validateArgumentsLength = __w_pdfjs_require__(129);
...
var _displayNode_utils = __w_pdfjs_require__(215);
var _canvas = __w_pdfjs_require__(222);
var _canvas_factory = __w_pdfjs_require__(216);
var _displayCmap_reader_factory = __w_pdfjs_require__(217);
var _filter_factory = __w_pdfjs_require__(218);
var _displayStandard_fontdata_factory = __w_pdfjs_require__(221);
var _worker_options = __w_pdfjs_require__(225);
var _metadata = __w_pdfjs_require__(226);
var _optional_content_config = __w_pdfjs_require__(227);
var _transport_stream = __w_pdfjs_require__(228);
var _displayFetch_stream = __w_pdfjs_require__(229);
var _displayNetwork = __w_pdfjs_require__(232);
var _displayNode_stream = __w_pdfjs_require__(233);
var _text_layer = __w_pdfjs_require__(234);
var _xfa_text = __w_pdfjs_require__(235);
const DEFAULT_RANGE_CHUNK_SIZE = 65536;
const RENDERING_CANCELLED_TIMEOUT = 100;
const DELAYED_CLEANUP_TIMEOUT = 5000;
const DefaultCanvasFactory = exports.DefaultCanvasFactory = _util.isNodeJS ? _displayNode_utils.NodeCanvasFactory : _canvas_factory.DOMCanvasFactory;
const DefaultCMapReaderFactory = exports.DefaultCMapReaderFactory = _util.isNodeJS ? _displayNode_utils.NodeCMapReaderFactory : _displayCmap_reader_factory.DOMCMapReaderFactory;
const DefaultFilterFactory = exports.DefaultFilterFactory = _util.isNodeJS ? _displayNode_utils.NodeFilterFactory : _filter_factory.DOMFilterFactory;
const DefaultStandardFontDataFactory = exports.DefaultStandardFontDataFactory = _util.isNodeJS ? _displayNode_utils.NodeStandardFontDataFactory : _displayStandard_fontdata_factory.DOMStandardFontDataFactory;
function getDocument() {
  ...
  const isImageDecoderSupported = typeof src.isImageDecoderSupported === "boolean" ? src.isImageDecoderSupported : !_util.isNodeJS && (_util.FeatureTest.platform.isFirefox || !globalThis.chrome);
  ...
  const useWorkerFetch = typeof src.useWorkerFetch === "boolean" ? src.useWorkerFetch : CMapReaderFactory === _displayCmap_reader_factory.DOMCMapReaderFactory && StandardFontDataFactory === _displayStandard_fontdata_factory.DOMStandardFontDataFactory && cMapUrl && standardFontDataUrl && (0, _display_utils.isValidFetchUrl)(cMapUrl, document.baseURI) && (0, _display_utils.isValidFetchUrl)(standardFontDataUrl, document.baseURI);
  ...
  worker.promise.then(function () {
    ...
    let networkStream;
    if (rangeTransport) {
      networkStream = new _transport_stream.PDFDataTransportStream(rangeTransport, {
        disableRange,
        disableStream
      });
    } else if (!data) {
      ...
      let NetworkStream;
      if (_util.isNodeJS) {
        if ((0, _display_utils.isValidFetchUrl)(url)) {
          ...
          NetworkStream = _displayFetch_stream.PDFFetchStream;
        } else {
          NetworkStream = _displayNode_stream.PDFNodeStream;
        }
      } else {
        NetworkStream = (0, _display_utils.isValidFetchUrl)(url) ? _displayFetch_stream.PDFFetchStream : _displayNetwork.PDFNetworkStream;
      }
...
class PDFPageProxy {
  ...
  render(_ref) {
    ...
    const intentPrint = !!(renderingIntent & _util.RenderingIntentFlag.PRINT);
  ...
  getTextContent() {
    ...
    if (this._transport._htmlForXfa) {
      return this.getXfa().then(xfa => _xfa_text.XfaText.textContent(xfa));
    }
...
class LoopbackPort {
  ...
  addEventListener(name, listener) {
    ...
    if (options?.signal instanceof AbortSignal) {
      ...
      if (signal.aborted) {
        (0, _util.warn)("LoopbackPort - cannot use an `aborted` signal.");
        return;
      }
...
class PDFWorker {
  ...
  static #_ = (() => {
    {
      if (_util.isNodeJS) {
        ...
        _worker_options.GlobalWorkerOptions.workerSrc ||= "./pdf.worker.mjs";
      }
  ...
  _setupFakeWorker() {
    ...
    PDFWorker._setupFakeWorkerGlobal.then(WorkerMessageHandler => {
      ...
      this._messageHandler = new _message_handler.MessageHandler(id, id + "_worker", port);
      this.#resolve();
    }).catch(reason => {
...
class WorkerTransport {
  ...
  getRenderingIntent(intent) {
    ...
    if (isEditing) {
      renderingIntent += _util.RenderingIntentFlag.IS_EDITING;
    }
    if (isOpList) {
  ...
  setupMessageHandler() {
    ...
    messageHandler.on("DocException", ex => {
      loadingTask._capability.reject((0, _message_handler.wrapReason)(ex));
    });
    messageHandler.on("PasswordRequest", ex => {
      this.#passwordCapability = Promise.withResolvers();
      try {
        if (!loadingTask.onPassword) {
          throw (0, _message_handler.wrapReason)(ex);
        }
    ...
    messageHandler.on("commonobj", _ref10 => {
      let [id, type, exportedData] = _ref10;
      if (this.destroyed) {
        return null;
      }
      ...
      switch (type) {
        ...
        case "CopyLocalImage":
          ...
          (0, _util.assert)(imageRef, "The imageRef must be defined.");
    ...
    messageHandler.on("obj", _ref11 => {
      let [id, pageIndex, type, imageData] = _ref11;
      if (this.destroyed) {
        return;
      }
      ...
      switch (type) {
        case "Image":
          ...
          if (imageData?.dataLen > _util.MAX_IMAGE_SIZE_TO_CACHE) {
  ...
  getOptionalContentConfig(renderingIntent) {
    return this.#cacheSimpleMethod("GetOptionalContentConfig").then(data => new _optional_content_config.OptionalContentConfig(data, renderingIntent));
  }
  getPermissions() {
...
const version = exports.version = '4.10.39';
const build = exports.build = 'f9bea397f';
...
var $ = __w_pdfjs_require__(3);
var map = __w_pdfjs_require__(135);
var IS_PURE = __w_pdfjs_require__(36);
$({
 target: 'Iterator',
 proto: true,
...
var aCallable = __w_pdfjs_require__(30);
var anObject = __w_pdfjs_require__(46);
var getIteratorDirect = __w_pdfjs_require__(136);
var createIteratorProxy = __w_pdfjs_require__(137);
var callWithSafeIterationClosing = __w_pdfjs_require__(146);
...
var call = __w_pdfjs_require__(8);
var create = __w_pdfjs_require__(138);
var createNonEnumerableProperty = __w_pdfjs_require__(43);
var defineBuiltIns = __w_pdfjs_require__(142);
var wellKnownSymbol = __w_pdfjs_require__(33);
var InternalStateModule = __w_pdfjs_require__(51);
var getMethod = __w_pdfjs_require__(29);
var IteratorPrototype = (__w_pdfjs_require__(143).IteratorPrototype);
var createIterResultObject = __w_pdfjs_require__(144);
var iteratorClose = __w_pdfjs_require__(145);
var TO_STRING_TAG = wellKnownSymbol('toStringTag');
...
var anObject = __w_pdfjs_require__(46);
var definePropertiesModule = __w_pdfjs_require__(139);
var enumBugKeys = __w_pdfjs_require__(65);
var hiddenKeys = __w_pdfjs_require__(54);
var html = __w_pdfjs_require__(141);
...
var anObject = __w_pdfjs_require__(46);
var toIndexedObject = __w_pdfjs_require__(12);
var objectKeys = __w_pdfjs_require__(140);
...
var $ = __w_pdfjs_require__(3);
var newPromiseCapabilityModule = __w_pdfjs_require__(149);
$({
 target: 'Promise',
 stat: true
}, {
...
var $ = __w_pdfjs_require__(3);
var difference = __w_pdfjs_require__(152);
var setMethodAcceptSetLike = __w_pdfjs_require__(160);
$({
 target: 'Set',
 proto: true,
 real: true,
...
var aSet = __w_pdfjs_require__(153);
var SetHelpers = __w_pdfjs_require__(154);
var clone = __w_pdfjs_require__(155);
var size = __w_pdfjs_require__(158);
var getSetRecord = __w_pdfjs_require__(159);
var iterateSet = __w_pdfjs_require__(156);
var iterateSimple = __w_pdfjs_require__(157);
...
var has = (__w_pdfjs_require__(154).has);
module.exports = function (it) {
 has(it);
 return it;
};
...
var SetHelpers = __w_pdfjs_require__(154);
var iterate = __w_pdfjs_require__(156);
...
var $ = __w_pdfjs_require__(3);
var fails = __w_pdfjs_require__(7);
var intersection = __w_pdfjs_require__(163);
var setMethodAcceptSetLike = __w_pdfjs_require__(160);
...
var $ = __w_pdfjs_require__(3);
var isDisjointFrom = __w_pdfjs_require__(166);
var setMethodAcceptSetLike = __w_pdfjs_require__(160);
$({
 target: 'Set',
 proto: true,
...
var $ = __w_pdfjs_require__(3);
var isSubsetOf = __w_pdfjs_require__(169);
var setMethodAcceptSetLike = __w_pdfjs_require__(160);
$({
 target: 'Set',
 proto: true,
...
var $ = __w_pdfjs_require__(3);
var isSupersetOf = __w_pdfjs_require__(172);
var setMethodAcceptSetLike = __w_pdfjs_require__(160);
$({
 target: 'Set',
 proto: true,
...
var $ = __w_pdfjs_require__(3);
var symmetricDifference = __w_pdfjs_require__(175);
var setMethodAcceptSetLike = __w_pdfjs_require__(160);
$({
 target: 'Set',
 proto: true,
...
var $ = __w_pdfjs_require__(3);
var union = __w_pdfjs_require__(178);
var setMethodAcceptSetLike = __w_pdfjs_require__(160);
$({
 target: 'Set',
 proto: true,
...
var aSet = __w_pdfjs_require__(153);
var add = (__w_pdfjs_require__(154).add);
var clone = __w_pdfjs_require__(155);
var getSetRecord = __w_pdfjs_require__(159);
var iterateSimple = __w_pdfjs_require__(157);
...
var uid = __w_pdfjs_require__(40);
var isCallable = __w_pdfjs_require__(21);
var isConstructor = __w_pdfjs_require__(180);
var isNullOrUndefined = __w_pdfjs_require__(17);
var isObject = __w_pdfjs_require__(20);
var isSymbol = __w_pdfjs_require__(22);
var iterate = __w_pdfjs_require__(181);
var anObject = __w_pdfjs_require__(46);
var classof = __w_pdfjs_require__(78);
var hasOwn = __w_pdfjs_require__(38);
var createProperty = __w_pdfjs_require__(186);
var createNonEnumerableProperty = __w_pdfjs_require__(43);
var lengthOfArrayLike = __w_pdfjs_require__(63);
var validateArgumentsLength = __w_pdfjs_require__(129);
var getRegExpFlags = __w_pdfjs_require__(187);
var MapHelpers = __w_pdfjs_require__(189);
var SetHelpers = __w_pdfjs_require__(154);
var setIterate = __w_pdfjs_require__(156);
var detachTransferable = __w_pdfjs_require__(118);
var ERROR_STACK_INSTALLABLE = __w_pdfjs_require__(83);
var PROPER_STRUCTURED_CLONE_TRANSFER = __w_pdfjs_require__(122);
...
var anObject = __w_pdfjs_require__(46);
var tryToString = __w_pdfjs_require__(31);
var isArrayIteratorMethod = __w_pdfjs_require__(182);
var lengthOfArrayLike = __w_pdfjs_require__(63);
var isPrototypeOf = __w_pdfjs_require__(24);
var getIterator = __w_pdfjs_require__(184);
var getIteratorMethod = __w_pdfjs_require__(185);
var iteratorClose = __w_pdfjs_require__(145);
var $TypeError = TypeError;
...
var wellKnownSymbol = __w_pdfjs_require__(33);
var Iterators = __w_pdfjs_require__(183);
var ITERATOR = wellKnownSymbol('iterator');
...
var hasOwn = __w_pdfjs_require__(38);
var isPrototypeOf = __w_pdfjs_require__(24);
var regExpFlags = __w_pdfjs_require__(188);
...
__w_pdfjs_require__(179);
var _util = __w_pdfjs_require__(1);
var _editor = __w_pdfjs_require__(191);
var _murmurhash = __w_pdfjs_require__(208);
...
class AnnotationStorage {
  ...
  get modifiedIds() {
    ...
    const ids = [];
    for (const value of this.#storage.values()) {
      if (!(value instanceof _editor.AnnotationEditor) || !value.annotationElementId || !value.serialize()) {
        continue;
      }
...
class PrintAnnotationStorage extends AnnotationStorage {
  ...
  get modifiedIds() {
    return (0, _util.shadow)(this, "modifiedIds", {
      ids: new Set(),
      hash: ""
    });
  }
...
__w_pdfjs_require__(2);
var _tools = __w_pdfjs_require__(192);
var _util = __w_pdfjs_require__(1);
var _display_utils = __w_pdfjs_require__(204);
var _alt_text = __w_pdfjs_require__(206);
var _toolbar = __w_pdfjs_require__(205);
var _touch_manager = __w_pdfjs_require__(207);
class AnnotationEditor {
  ...
  #resizerPointerdown(name, event) {
    ...
    window.addEventListener("touchmove", _display_utils.stopEvent, {
      passive: false,
      signal
    });
    window.addEventListener("contextmenu", _display_utils.noContextMenu, {
      signal
    });
  ...
  async addEditToolbar() {
    ...
    this._editToolbar = new _toolbar.EditorToolbar(this);
  ...
  async addAltTextButton() {
    ...
    _alt_text.AltText.initialize(AnnotationEditor._l10n);
    this.#altText = new _alt_text.AltText(this);
  ...
  render() {
    ...
    if (this.isResizable && this._uiManager._supportsPinchToZoom) {
      this.#touchManager ||= new _touch_manager.TouchManager({
        container: this.div,
  ...
  #setUpDragSession(event) {
    ...
    if (isSelected) {
      ...
      window.addEventListener("touchmove", _display_utils.stopEvent, opts);
  ...
  async #get(key, rawData) {
    ...
    try {
      ...
      if (typeof rawData === "string") {
        data.url = rawData;
        image = await (0, _display_utils.fetchData)(rawData, "blob");
...
class KeyboardManager {
  ...
  exec(self, event) {
    ...
    if (!bubbles) {
      (0, _display_utils.stopEvent)(event);
    }
  }
}
...
class AnnotationEditorUIManager {
  ...
  static get _keyboardManager() {
    ...
    return (0, _util.shadow)(this, "_keyboardManager", new KeyboardManager([[["ctrl+a", "mac+meta+a"], proto.selectAll, {
  ...
  get highlightColors() {
    return (0, _util.shadow)(this, "highlightColors", this.#highlightColors ? new Map(this.#highlightColors.split(",").map(pair => pair.split("=").map(x => x.trim()))) : null);
  }
  get highlightColorNames() {
    return (0, _util.shadow)(this, "highlightColorNames", this.highlightColors ? new Map(Array.from(this.highlightColors, e => e.reverse())) : null);
  }
  ...
  #getAnchorElementForSelection(_ref9) {
    let {
      anchorNode
    } = _ref9;
  ...
  highlightSelection() {
    ...
    const isNoneMode = this.#mode === _util.AnnotationEditorType.NONE;
    const callback = () => {
    ...
    if (isNoneMode) {
      this.switchToMode(_util.AnnotationEditorType.HIGHLIGHT, callback);
      return;
    }
    callback();
  }
  #displayHighlightToolbar() {
    ...
    this.#highlightToolbar ||= new _toolbar.HighlightToolbar(this);
  ...
  #selectionChange() {
    ...
    if (this.#mode !== _util.AnnotationEditorType.HIGHLIGHT && this.#mode !== _util.AnnotationEditorType.NONE) {
      return;
    }
    if (this.#mode === _util.AnnotationEditorType.HIGHLIGHT) {
      this.showAllEditors("highlight", true, true);
    }
    this.#highlightWhenShiftUp = this.isShiftKeyDown;
    if (!this.isShiftKeyDown) {
      const activeLayer = this.#mode === _util.AnnotationEditorType.HIGHLIGHT ? this.#getLayerForTextLayer(textLayer) : null;
  ...
  keydown(event) {
    ...
    if (this.#mode !== _util.AnnotationEditorType.NONE && !this.isEditorHandlingKeyboard) {
  ...
  #dispatchUpdateStates(details) {
    ...
    if (hasChanged) {
      ...
      if (this.#mode === _util.AnnotationEditorType.HIGHLIGHT && details.hasSelectedEditor === false) {
        this.#dispatchUpdateUI([[_util.AnnotationEditorParamsType.HIGHLIGHT_FREE, true]]);
      }
    }
  }
  ...
  updateParams(type, value) {
    ...
    switch (type) {
      case _util.AnnotationEditorParamsType.CREATE:
        this.currentLayer.addNewEditor();
        return;
      case _util.AnnotationEditorParamsType.HIGHLIGHT_DEFAULT_COLOR:
        this.#mainHighlightColorPicker?.updateColor(value);
        break;
      case _util.AnnotationEditorParamsType.HIGHLIGHT_SHOW_ALL:
  ...
  showAllEditors(type, visible) {
    ...
    const state = this.#showAllStates?.get(_util.AnnotationEditorParamsType.HIGHLIGHT_SHOW_ALL) ?? true;
    if (state !== visible) {
      this.#dispatchUpdateUI([[_util.AnnotationEditorParamsType.HIGHLIGHT_SHOW_ALL, visible]]);
    }
  }
  enableWaiting() {
  ...
  unselectAll() {
    if (this.#activeEditor) {
      this.#activeEditor.commitOrRemove();
      if (this.#mode !== _util.AnnotationEditorType.NONE) {
        return;
      }
    }
  ...
  addChangedExistingAnnotation(_ref12) {
    let {
      annotationElementId,
      id
    } = _ref12;
  ...
  removeChangedExistingAnnotation(_ref13) {
    let {
      annotationElementId
    } = _ref13;
  ...
  renderAnnotationElement(annotation) {
    ...
    if (this.#mode === _util.AnnotationEditorType.NONE && !editor.hasBeenModified) {
      return;
    }
...
var anObject = __w_pdfjs_require__(46);
var getIteratorDirect = __w_pdfjs_require__(136);
var notANaN = __w_pdfjs_require__(197);
var toPositiveInteger = __w_pdfjs_require__(100);
var createIteratorProxy = __w_pdfjs_require__(137);
var IS_PURE = __w_pdfjs_require__(36);
var IteratorProxy = createIteratorProxy(function () {
...
$({
 ...
 drop: function drop(limit) {
  ...
  return new IteratorProxy(getIteratorDirect(this), { remaining: remaining });
 }
});
...
var createProperty = __w_pdfjs_require__(186);
var fails = __w_pdfjs_require__(7);
var parseJSONString = __w_pdfjs_require__(203);
var NATIVE_SYMBOL = __w_pdfjs_require__(26);
...
exports.StatTimer = exports.SVG_NS = exports.RenderingCancelledException = exports.PixelsPerInch = exports.PageViewport = exports.PDFDateString = exports.OutputScale = void 0;
...
const SVG_NS = exports.SVG_NS = "http://www.w3.org/2000/svg";
class PixelsPerInch {
  static CSS = 96.0;
  static PDF = 72.0;
...
exports.HighlightToolbar = exports.EditorToolbar = void 0;
var _display_utils = __w_pdfjs_require__(204);
class EditorToolbar {
  #toolbar = null;
  #colorPicker = null;
  ...
  render() {
    ...
    editToolbar.addEventListener("contextmenu", _display_utils.noContextMenu, {
      signal
    });
  ...
  #addListenersToElement(element) {
    ...
    element.addEventListener("contextmenu", _display_utils.noContextMenu, {
      signal
    });
  }
  hide() {
...
class HighlightToolbar {
  ...
  #addHighlightButton() {
    ...
    button.addEventListener("contextmenu", _display_utils.noContextMenu, {
      signal
    });
...
exports.HighlightToolbar = HighlightToolbar;
...
class TouchManager {
  ...
  get MIN_TOUCH_DISTANCE_TO_PINCH() {
    return (0, _util.shadow)(this, "MIN_TOUCH_DISTANCE_TO_PINCH", 35 / (window.devicePixelRatio || 1));
  }
  #onTouchStart(evt) {
    ...
    (0, _display_utils.stopEvent)(evt);
...
class FontFaceObject {
  ...
  createFontFaceRule() {
    ...
    const url = `url(data:${this.mimetype};base64,${(0, _util.toBase64Util)(this.data)});`;
    let rule;
    if (!this.cssFontInfo) {
...
function wrapReason(ex) {
  if (ex instanceof _util.AbortException || ex instanceof _util.InvalidPDFException || ex instanceof _util.MissingPDFException || ex instanceof _util.PasswordException || ex instanceof _util.UnexpectedResponseException || ex instanceof _util.UnknownErrorException) {
    return ex;
  }
  ...
  switch (ex.name) {
    case "AbortException":
      return new _util.AbortException(ex.message);
    case "InvalidPDFException":
      return new _util.InvalidPDFException(ex.message);
    case "MissingPDFException":
      return new _util.MissingPDFException(ex.message);
    case "PasswordException":
      return new _util.PasswordException(ex.message, ex.code);
    case "UnexpectedResponseException":
      return new _util.UnexpectedResponseException(ex.message, ex.status);
    case "UnknownErrorException":
      return new _util.UnknownErrorException(ex.message, ex.details);
  }
  return new _util.UnknownErrorException(ex.message, ex.toString());
}
...
var globalThis = __w_pdfjs_require__(4);
var apply = __w_pdfjs_require__(68);
var slice = __w_pdfjs_require__(213);
var newPromiseCapabilityModule = __w_pdfjs_require__(149);
var aCallable = __w_pdfjs_require__(30);
var perform = __w_pdfjs_require__(214);
...
var _util = __w_pdfjs_require__(1);
var _canvas_factory = __w_pdfjs_require__(216);
var _cmap_reader_factory = __w_pdfjs_require__(217);
var _filter_factory = __w_pdfjs_require__(218);
var _standard_fontdata_factory = __w_pdfjs_require__(221);
;
if (_util.isNodeJS) {
  let canvas;
  try {
    const require = process.getBuiltinModule("module").createRequire("file:///C:/laragon/www/git/dearviewer/ref/pdf.js/src/display/node_utils.js");
    try {
      canvas = require("@napi-rs/canvas");
    } catch (ex) {
      (0, _util.warn)(`Cannot load "@napi-rs/canvas" package: "${ex}".`);
    }
  } catch (ex) {
    (0, _util.warn)(`Cannot access the \`require\` function: "${ex}".`);
  }
  if (!globalThis.DOMMatrix) {
    if (canvas?.DOMMatrix) {
      globalThis.DOMMatrix = canvas.DOMMatrix;
    } else {
      (0, _util.warn)("Cannot polyfill `DOMMatrix`, rendering may be broken.");
    }
  }
  if (!globalThis.ImageData) {
    if (canvas?.ImageData) {
      ...
      (0, _util.warn)("Cannot polyfill `ImageData`, rendering may be broken.");
    }
  }
  if (!globalThis.Path2D) {
    if (canvas?.Path2D) {
      ...
      (0, _util.warn)("Cannot polyfill `Path2D`, rendering may be broken.");
    }
  }
}
async function fetchData(url) {
...
class NodeFilterFactory extends _filter_factory.BaseFilterFactory {}
exports.NodeFilterFactory = NodeFilterFactory;
class NodeCanvasFactory extends _canvas_factory.BaseCanvasFactory {
...
class NodeCMapReaderFactory extends _cmap_reader_factory.BaseCMapReaderFactory {
  async _fetch(url) {
    return fetchData(url);
  }
}
exports.NodeCMapReaderFactory = NodeCMapReaderFactory;
class NodeStandardFontDataFactory extends _standard_fontdata_factory.BaseStandardFontDataFactory {
  async _fetch(url) {
    return fetchData(url);
  }
}
...
exports.DOMCanvasFactory = exports.BaseCanvasFactory = void 0;
__w_pdfjs_require__(2);
var _util = __w_pdfjs_require__(1);
...
exports.DOMCMapReaderFactory = exports.BaseCMapReaderFactory = void 0;
__w_pdfjs_require__(2);
__w_pdfjs_require__(88);
__w_pdfjs_require__(97);
__w_pdfjs_require__(98);
...
class BaseCMapReaderFactory {
  ...
  async _fetch(url) {
    (0, _util.unreachable)("Abstract method `_fetch` called.");
  }
}
exports.BaseCMapReaderFactory = BaseCMapReaderFactory;
class DOMCMapReaderFactory extends BaseCMapReaderFactory {
  async _fetch(url) {
    const data = await (0, _display_utils.fetchData)(url, this.isCompressed ? "arraybuffer" : "text");
    return data instanceof ArrayBuffer ? new Uint8Array(data) : (0, _util.stringToBytes)(data);
  }
}
...
exports.DOMFilterFactory = exports.BaseFilterFactory = void 0;
__w_pdfjs_require__(193);
...
class DOMFilterFactory extends BaseFilterFactory {
  ...
  get #defs() {
    if (!this.#_defs) {
      ...
      style.zIndex = -1;
      const svg = this.#document.createElementNS(_display_utils.SVG_NS, "svg");
      svg.setAttribute("width", 0);
      svg.setAttribute("height", 0);
      this.#_defs = this.#document.createElementNS(_display_utils.SVG_NS, "defs");
      div.append(svg);
  ...
  #createUrl(id) {
    if (this.#baseUrl === undefined) {
      ...
      if (url !== this.#document.baseURI) {
        if ((0, _display_utils.isDataScheme)(url)) {
          (0, _util.warn)('#createUrl: ignore "data:"-URL for performance reasons.');
        } else {
  ...
  #addLuminosityConversion(filter) {
    const feColorMatrix = this.#document.createElementNS(_display_utils.SVG_NS, "feColorMatrix");
  ...
  #createFilter(id) {
    const filter = this.#document.createElementNS(_display_utils.SVG_NS, "filter");
  ...
  #appendFeFunc(feComponentTransfer, func, table) {
    const feFunc = this.#document.createElementNS(_display_utils.SVG_NS, func);
    feFunc.setAttribute("type", "discrete");
    feFunc.setAttribute("tableValues", table);
    feComponentTransfer.append(feFunc);
  }
  #addTransferMapConversion(rTable, gTable, bTable, filter) {
    const feComponentTransfer = this.#document.createElementNS(_display_utils.SVG_NS, "feComponentTransfer");
  ...
  #getRGB(color) {
    ...
    return (0, _display_utils.getRGB)(getComputedStyle(this.#defs).getPropertyValue("color"));
  }
}
...
exports.DOMStandardFontDataFactory = exports.BaseStandardFontDataFactory = void 0;
__w_pdfjs_require__(2);
__w_pdfjs_require__(88);
__w_pdfjs_require__(97);
__w_pdfjs_require__(98);
...
class DOMStandardFontDataFactory extends BaseStandardFontDataFactory {
  async _fetch(url) {
    const data = await (0, _display_utils.fetchData)(url, "arraybuffer");
    return new Uint8Array(data);
  }
}
...
var _util = __w_pdfjs_require__(1);
var _display_utils = __w_pdfjs_require__(204);
var _pattern_helper = __w_pdfjs_require__(223);
var _image_utils = __w_pdfjs_require__(224);
...
class CanvasExtraState {
  ...
  updateCurvePathMinMax(transform, x0, y0, x1, y1, x2, y2, x3, y3, minMax) {
    const box = _util.Util.bezierBoundingBox(x0, y0, x1, y1, x2, y2, x3, y3, minMax);
    if (minMax) {
      return;
    }
...
class CanvasGraphics {
  ...
  _createMaskCanvas(img) {
    ...
    const [minX, minY, maxX, maxY] = _util.Util.getAxialAlignedBoundingBox([0, 0, width, height], maskToCanvas);
  ...
  genericComposeSMask(maskCtx, layerCtx, width, height, subtype, backdrop, transferMap, layerOffsetX, layerOffsetY, maskOffsetX, maskOffsetY) {
    ...
    if (backdrop) {
      const backdropRGB = _util.Util.makeHexColor(...backdrop);
  ...
  showText(glyphs) {
    ...
    if (current.patternFill) {
      ...
      patternFillTransform = (0, _display_utils.getCurrentTransform)(ctx);
      ctx.restore();
      ctx.fillStyle = pattern;
    }
    if (current.patternStroke) {
      ctx.save();
      const pattern = current.strokeColor.getPattern(ctx, this, (0, _display_utils.getCurrentTransformInverse)(ctx), _pattern_helper.PathType.STROKE);
      patternStrokeTransform = (0, _display_utils.getCurrentTransform)(ctx);
      ctx.restore();
  ...
  setStrokeRGBColor(r, g, b) {
    this.ctx.strokeStyle = this.current.strokeColor = _util.Util.makeHexColor(r, g, b);
  ...
  setFillRGBColor(r, g, b) {
    this.ctx.fillStyle = this.current.fillColor = _util.Util.makeHexColor(r, g, b);
...
class OptionalContentGroup {
  ...
  constructor(renderingIntent, _ref) {
    ...
    this.#isDisplay = !!(renderingIntent & _util.RenderingIntentFlag.DISPLAY);
    this.#isPrint = !!(renderingIntent & _util.RenderingIntentFlag.PRINT);
    this.name = name;
    this.intent = intent;
    this.usage = usage;
...
class OptionalContentConfig {
  ...
  #order = null;
  constructor(data) {
    let renderingIntent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _util.RenderingIntentFlag.DISPLAY;
  ...
  isVisible(group) {
    ...
    if (!group) {
      (0, _util.info)("Optional content group not defined.");
      return true;
    }
    if (group.type === "OCG") {
...
class PDFFetchStream {
  ...
  constructor(source) {
    ...
    this.headers = (0, _network_utils.createHeaders)(this.isHttp, source.httpHeaders);
    this._fullRequestReader = null;
...
class PDFFetchStreamReader {
  constructor(stream) {
    ...
    fetch(url, createFetchOptions(headers, this._withCredentials, this._abortController)).then(response => {
      stream._responseOrigin = (0, _network_utils.getResponseOrigin)(response.url);
      ...
      this._filename = (0, _network_utils.extractFilenameFromHeader)(responseHeaders);
...
class PDFFetchStreamRangeReader {
  constructor(stream, begin, end) {
    ...
    const url = source.url;
    fetch(url, createFetchOptions(headers, this._withCredentials, this._abortController)).then(response => {
      const responseOrigin = (0, _network_utils.getResponseOrigin)(response.url);
...
exports.getResponseOrigin = getResponseOrigin;
...
class NetworkManager {
  ...
  constructor(_ref) {
    ...
    this.headers = (0, _network_utils.createHeaders)(this.isHttp, httpHeaders);
  ...
  request(args) {
    ...
    (0, _util.assert)(args.onError, "Expected `onError` callback to be provided.");
    xhr.onerror = () => {
  ...
  onStateChange(xhrId, evt) {
    ...
    if (xhrStatus === PARTIAL_CONTENT_RESPONSE) {
      ...
      if (matches) {
        ...
        (0, _util.warn)(`Missing or invalid "Content-Range" header.`);
...
class PDFNetworkStreamFullRequestReader {
  ...
  _onHeadersReceived() {
    ...
    this._manager._responseOrigin = (0, _network_utils.getResponseOrigin)(fullRequestXhr.responseURL);
...
class PDFNetworkStreamRangeRequestReader {
  ...
  _onHeadersReceived() {
    const responseOrigin = (0, _network_utils.getResponseOrigin)(this._manager.getRequestXhr(this._requestId)?.responseURL);
...
class PDFNodeStream {
  constructor(source) {
    ...
    (0, _util.assert)(this.url.protocol === "file:", "PDFNodeStream only supports file:// URLs.");
    this._fullRequestReader = null;
    this._rangeRequestReaders = [];
  }
  get _progressiveDataLength() {
  ...
  constructor(stream) {
    ...
    fs.promises.lstat(this._url).then(stat => {
      ...
      if (error.code === "ENOENT") {
        error = new _util.MissingPDFException(`Missing PDF "${this._url}".`);
      }
...
class TextLayer {
  ...
  static get fontFamilyMap() {
    ...
    return (0, _util.shadow)(this, "fontFamilyMap", new Map([["sans-serif", `${isWindows && isFirefox ? "Calibri, " : ""}sans-serif`], ["monospace", `${isWindows && isFirefox ? "Lucida Console, " : ""}monospace`]]));
  }
  render() {
    const pump = () => {
      this.#reader.read().then(_ref2 => {
        let {
          value,
          done
        } = _ref2;
  ...
  update(_ref3) {
    ...
    if (rotation !== this.#rotation) {
      onBefore?.();
      this.#rotation = rotation;
      (0, _display_utils.setLayerDimensions)(this.#rootContainer, {
        rotation
      });
    }
    if (scale !== this.#scale) {
  ...
  cancel() {
    const abortEx = new _util.AbortException("TextLayer task cancelled.");
  ...
  #processItems(items) {
    ...
    for (const item of items) {
      if (textDivs.length > MAX_TEXT_DIVS_TO_RENDER) {
        (0, _util.warn)("Ignoring additional textDivs for performance reasons.");
  ...
  #appendText(geom) {
    ...
    const tx = _util.Util.transform(this.#transform, geom.transform);
...
var _util = __w_pdfjs_require__(1);
var _editor = __w_pdfjs_require__(191);
var _freetext = __w_pdfjs_require__(237);
var _highlight = __w_pdfjs_require__(245);
var _ink = __w_pdfjs_require__(250);
var _display_utils = __w_pdfjs_require__(204);
var _stamp = __w_pdfjs_require__(253);
class AnnotationEditorLayer {
  ...
  static #editorTypes = (() => new Map([_freetext.FreeTextEditor, _ink.InkEditor, _stamp.StampEditor, _highlight.HighlightEditor].map(type => [type._editorType, type])))();
  constructor(_ref) {
    let {
      uiManager,
      pageIndex,
  ...
  get isInvisible() {
    return this.isEmpty && this.#uiManager.getMode() === _util.AnnotationEditorType.NONE;
  }
  updateToolbar(mode) {
  ...
  updateMode() {
    ...
    this.#cleanup();
    switch (mode) {
      case _util.AnnotationEditorType.NONE:
      ...
      case _util.AnnotationEditorType.INK:
        ...
        this.enableClick();
        break;
      case _util.AnnotationEditorType.HIGHLIGHT:
  ...
  #textLayerPointerDown(event) {
    ...
    if (target === this.#textLayer.div || (target.getAttribute("role") === "img" || target.classList.contains("endOfContent")) && this.#textLayer.div.contains(target)) {
      ...
      this.toggleDrawing();
      _highlight.HighlightEditor.startHighlighting(this, this.#uiManager.direction === "ltr", {
  ...
  pointerdown(event) {
    if (this.#uiManager.getMode() === _util.AnnotationEditorType.HIGHLIGHT) {
      this.enableTextSelection();
    }
    if (this.#hadPointerDown) {
      this.#hadPointerDown = false;
...
class FreeTextEditor extends _editor.AnnotationEditor {
  ...
  static initialize(l10n, uiManager) {
    _editor.AnnotationEditor.initialize(l10n, uiManager);
    const style = getComputedStyle(document.documentElement);
...
exports.StampAnnotationElement = exports.InkAnnotationElement = exports.HighlightAnnotationElement = exports.FreeTextAnnotationElement = exports.AnnotationLayer = void 0;
__w_pdfjs_require__(84);
__w_pdfjs_require__(193);
...
var _display_utils = __w_pdfjs_require__(204);
var _annotation_storage = __w_pdfjs_require__(190);
var _scripting_utils = __w_pdfjs_require__(242);
var _svg_factory = __w_pdfjs_require__(243);
var _xfa_layer = __w_pdfjs_require__(244);
...
class AnnotationElement {
  ...
  _createContainer(ignoreBorder) {
    ...
    if (!ignoreBorder && data.borderStyle.width > 0) {
      ...
      if (borderColor) {
        this.#hasBorder = true;
        style.borderColor = _util.Util.makeHexColor(borderColor[0] | 0, borderColor[1] | 0, borderColor[2] | 0);
      } else {
        style.borderWidth = 0;
      }
    }
...
class WidgetAnnotationElement extends AnnotationElement {
  ...
  _getKeyModifier(event) {
    return _util.FeatureTest.platform.isMac ? event.metaKey : event.ctrlKey;
  }
...
class PopupElement {
  ...
  constructor(_ref2) {
    ...
    this.#elements = elements;
    this.#dateObj = _display_utils.PDFDateString.toDateObject(modificationDate);
...
class InkAnnotationElement extends AnnotationElement {
  ...
  constructor(parameters) {
    ...
    this.svgElementName = "svg:polyline";
    this.annotationEditorType = this.data.it === "InkHighlight" ? _util.AnnotationEditorType.HIGHLIGHT : _util.AnnotationEditorType.INK;
  }
...
class HighlightAnnotationElement extends AnnotationElement {
  constructor(parameters) {
    ...
    this.annotationEditorType = _util.AnnotationEditorType.HIGHLIGHT;
  }
  render() {
    if (!this.data.popupRef && this.hasPopupData) {
      this._createPopup();
...
exports.HighlightAnnotationElement = HighlightAnnotationElement;
...
class StampAnnotationElement extends AnnotationElement {
  constructor(parameters) {
    ...
    this.annotationEditorType = _util.AnnotationEditorType.STAMP;
  }
  render() {
...
class AnnotationLayer {
  ...
  async #appendElement(element, id) {
    ...
    const annotationId = contentElement.id = `${_util.AnnotationPrefix}${id}`;
  ...
  async render(params) {
    ...
    const elementParams = {
      ...
      svgFactory: new _svg_factory.DOMSVGFactory(),
...
var anObject = __w_pdfjs_require__(46);
var getIteratorDirect = __w_pdfjs_require__(136);
var getIteratorFlattenable = __w_pdfjs_require__(241);
var createIteratorProxy = __w_pdfjs_require__(137);
var iteratorClose = __w_pdfjs_require__(145);
var IS_PURE = __w_pdfjs_require__(36);
var IteratorProxy = createIteratorProxy(function () {
...
exports.DOMSVGFactory = exports.BaseSVGFactory = void 0;
__w_pdfjs_require__(2);
var _display_utils = __w_pdfjs_require__(204);
var _util = __w_pdfjs_require__(1);
...
class DOMSVGFactory extends BaseSVGFactory {
  _createSVG(type) {
    return document.createElementNS(_display_utils.SVG_NS, type);
  }
}
  ...
  static render(parameters) {
    ...
    if (root.children.length === 0) {
      if (root.value) {
        ...
        if (isNotForRichText && _xfa_text.XfaText.shouldBuildText(root.name)) {
          textDivs.push(node);
        }
      }
      return {
    ...
    while (stack.length > 0) {
      ...
      if (child.children?.length > 0) {
        ...
        const node = document.createTextNode(child.value);
        if (isNotForRichText && _xfa_text.XfaText.shouldBuildText(name)) {
          textDivs.push(node);
        }
...
var _util = __w_pdfjs_require__(1);
var _tools = __w_pdfjs_require__(192);
var _highlight = __w_pdfjs_require__(246);
var _annotation_layer = __w_pdfjs_require__(238);
var _display_utils = __w_pdfjs_require__(204);
var _editor = __w_pdfjs_require__(191);
var _color_picker = __w_pdfjs_require__(249);
class HighlightEditor extends _editor.AnnotationEditor {
  #anchorNode = null;
  #anchorOffset = 0;
  #boxes;
  #clipPathId = null;
  ...
  static _editorType = (() => _util.AnnotationEditorType.HIGHLIGHT)();
  static _freeHighlightId = (() => -1)();
  static _freeHighlight = null;
  static _freeHighlightClipId = "";
  static get _keyboardManager() {
    const proto = HighlightEditor.prototype;
    return (0, _util.shadow)(this, "_keyboardManager", new _tools.KeyboardManager([[["ArrowLeft", "mac+ArrowLeft"], proto._moveCaret, {
      args: [0]
  ...
  #createOutlines() {
    const outliner = new _highlight.HighlightOutliner(this.#boxes, 0.001);
    this.#highlightOutlines = outliner.getOutlines();
    [this.x, this.y, this.width, this.height] = this.#highlightOutlines.box;
    const outlinerForOutline = new _highlight.HighlightOutliner(this.#boxes, 0.0025, 0.001, this._uiManager.direction === "ltr");
  ...
  static updateDefaultParams(type, value) {
    switch (type) {
      case _util.AnnotationEditorParamsType.HIGHLIGHT_DEFAULT_COLOR:
        ...
        break;
      case _util.AnnotationEditorParamsType.HIGHLIGHT_THICKNESS:
  ...
  updateParams(type, value) {
    switch (type) {
      case _util.AnnotationEditorParamsType.HIGHLIGHT_COLOR:
        this.#updateColor(value);
        break;
      case _util.AnnotationEditorParamsType.HIGHLIGHT_THICKNESS:
  ...
  static get defaultPropertiesToUpdate() {
    return [[_util.AnnotationEditorParamsType.HIGHLIGHT_DEFAULT_COLOR, HighlightEditor._defaultColor], [_util.AnnotationEditorParamsType.HIGHLIGHT_THICKNESS, HighlightEditor._defaultThickness]];
  }
  get propertiesToUpdate() {
    return [[_util.AnnotationEditorParamsType.HIGHLIGHT_COLOR, this.color || HighlightEditor._defaultColor], [_util.AnnotationEditorParamsType.HIGHLIGHT_THICKNESS, this.#thickness || HighlightEditor._defaultThickness], [_util.AnnotationEditorParamsType.HIGHLIGHT_FREE, this.#isFreeHighlight]];
  }
  #updateColor(color) {
    ...
    this.addCommands({
      ...
      post: this._uiManager.updateUI.bind(this._uiManager, this),
      mustExec: true,
      type: _util.AnnotationEditorParamsType.HIGHLIGHT_COLOR,
      overwriteIfSameType: true,
      keepUndo: true
    });
  ...
  async addEditToolbar() {
    ...
    if (this._uiManager.highlightColors) {
      this.#colorPicker = new _color_picker.ColorPicker({
        editor: this
      });
  ...
  render() {
    ...
    const [parentWidth, parentHeight] = this.parentDimensions;
    this.setDims(this.width * parentWidth, this.height * parentHeight);
    (0, _tools.bindEvents)(this, this.#highlightDiv, ["pointerover", "pointerleave"]);
    this.enableEditing();
    return div;
  }
  pointerover() {
  ...
  static startHighlighting(parent, isLTR, _ref3) {
    ...
    window.addEventListener("pointerdown", _display_utils.stopEvent, {
      capture: true,
      passive: false,
      signal
    });
    ...
    this._freeHighlight = new _highlight.FreeHighlightOutliner({
      x,
      y
  ...
  static async deserialize(data, parent, uiManager) {
    let initialData = null;
    if (data instanceof _annotation_layer.HighlightAnnotationElement) {
      const {
        data: {
          quadPoints,
          rect,
      ...
      initialData = data = {
        annotationType: _util.AnnotationEditorType.HIGHLIGHT,
    ...
    } else if (data instanceof _annotation_layer.InkAnnotationElement) {
      const {
        data: {
          inkLists,
          rect,
    ...
    const editor = await super.deserialize(data, parent, uiManager);
    editor.color = _util.Util.makeHexColor(...color);
    ...
    if (quadPoints) {
      ...
      const outliner = new _highlight.FreeHighlightOutliner(point, [0, 0, pageWidth, pageHeight], 1, editor.#thickness / 2, true, 0.001);
  ...
  serialize() {
    ...
    const color = _editor.AnnotationEditor._colorManager.convert(this.color);
    const serialized = {
      annotationType: _util.AnnotationEditorType.HIGHLIGHT,
      color,
...
exports.HighlightOutliner = exports.FreeHighlightOutliner = void 0;
__w_pdfjs_require__(84);
__w_pdfjs_require__(88);
__w_pdfjs_require__(97);
__w_pdfjs_require__(98);
...
__w_pdfjs_require__(173);
__w_pdfjs_require__(176);
var _freedraw = __w_pdfjs_require__(247);
var _outline = __w_pdfjs_require__(248);
...
exports.HighlightOutliner = HighlightOutliner;
class HighlightOutline extends _outline.Outline {
  #box;
  #outlines;
...
class FreeHighlightOutliner extends _freedraw.FreeDrawOutliner {
  newFreeDrawOutline(outline, points, box, scaleFactor, innerMargin, isLTR) {
    return new FreeHighlightOutline(outline, points, box, scaleFactor, innerMargin, isLTR);
  }
}
exports.FreeHighlightOutliner = FreeHighlightOutliner;
class FreeHighlightOutline extends _freedraw.FreeDrawOutline {
...
exports.FreeDrawOutliner = exports.FreeDrawOutline = void 0;
__w_pdfjs_require__(84);
__w_pdfjs_require__(88);
__w_pdfjs_require__(97);
__w_pdfjs_require__(98);
...
exports.FreeDrawOutliner = FreeDrawOutliner;
class FreeDrawOutline extends _outline.Outline {
  #box;
  ...
  serialize(_ref3, rotation) {
    ...
    switch (rotation) {
      case 0:
        outline = _outline.Outline._rescale(this.#outline, blX, trY, width, -height);
        points = _outline.Outline._rescale(this.#points, blX, trY, width, -height);
        break;
      case 90:
        outline = _outline.Outline._rescaleAndSwap(this.#outline, blX, blY, width, height);
        points = _outline.Outline._rescaleAndSwap(this.#points, blX, blY, width, height);
        break;
      case 180:
        outline = _outline.Outline._rescale(this.#outline, trX, blY, -width, height);
        points = _outline.Outline._rescale(this.#points, trX, blY, -width, height);
        break;
      case 270:
        outline = _outline.Outline._rescaleAndSwap(this.#outline, trX, trY, -width, -height);
        points = _outline.Outline._rescaleAndSwap(this.#points, trX, trY, -width, -height);
        break;
    }
    return {
  ...
  #computeMinMax(isLTR) {
    ...
    for (let i = 6, ii = outline.length; i < ii; i += 6) {
      if (isNaN(outline[i])) {
        ...
        const bbox = _util.Util.bezierBoundingBox(lastX, lastY, ...outline.slice(i, i + 6));
...
exports.FreeDrawOutline = FreeDrawOutline;
...
class Outline {
  ...
  toSVGPath() {
    (0, _util.unreachable)("Abstract method `toSVGPath` must be implemented.");
  }
  get box() {
    (0, _util.unreachable)("Abstract getter `box` must be implemented.");
  }
  serialize(_bbox, _rotation) {
    (0, _util.unreachable)("Abstract method `serialize` must be implemented.");
  }
...
class ColorPicker {
  ...
  static get _keyboardManager() {
    return (0, _util.shadow)(this, "_keyboardManager", new _tools.KeyboardManager([[["Escape", "mac+Escape"], ColorPicker.prototype._hideDropdownFromKeyboard], [[" ", "mac+ "], ColorPicker.prototype._colorSelectFromKeyboard], [["ArrowDown", "ArrowRight", "mac+ArrowDown", "mac+ArrowRight"], ColorPicker.prototype._moveToNext], [["ArrowUp", "ArrowLeft", "mac+ArrowUp", "mac+ArrowLeft"], ColorPicker.prototype._moveToPrevious], [["Home", "mac+Home"], ColorPicker.prototype._moveToBeginning], [["End", "mac+End"], ColorPicker.prototype._moveToEnd]]));
  }
  constructor(_ref) {
    let {
      editor = null,
    ...
    if (editor) {
      ...
      this.#type = _util.AnnotationEditorParamsType.HIGHLIGHT_COLOR;
      this.#editor = editor;
    } else {
      this.#isMainColorPicker = true;
      this.#type = _util.AnnotationEditorParamsType.HIGHLIGHT_DEFAULT_COLOR;
    }
...
__w_pdfjs_require__(200);
var _util = __w_pdfjs_require__(1);
var _draw = __w_pdfjs_require__(251);
var _inkdraw = __w_pdfjs_require__(252);
var _editor = __w_pdfjs_require__(191);
var _annotation_layer = __w_pdfjs_require__(238);
class InkDrawingOptions extends _draw.DrawingOptions {
  #viewParameters;
  constructor(viewerParameters) {
    ...
    super.updateProperties({
      fill: "none",
      stroke: _editor.AnnotationEditor._defaultLineColor,
      "stroke-opacity": 1,
      "stroke-width": 1,
...
class InkEditor extends _draw.DrawingEditor {
  static _type = "ink";
  ...
  static get typesMap() {
    return (0, _util.shadow)(this, "typesMap", new Map([[_util.AnnotationEditorParamsType.INK_THICKNESS, "stroke-width"], [_util.AnnotationEditorParamsType.INK_COLOR, "stroke"], [_util.AnnotationEditorParamsType.INK_OPACITY, "stroke-opacity"]]));
  }
  static createDrawerInstance(x, y, parentWidth, parentHeight, rotation) {
    return new _inkdraw.InkDrawOutliner(x, y, parentWidth, parentHeight, rotation, this._defaultDrawingOptions["stroke-width"]);
  }
  static deserializeDraw(pageX, pageY, pageWidth, pageHeight, innerMargin, data) {
    return _inkdraw.InkDrawOutline.deserialize(pageX, pageY, pageWidth, pageHeight, innerMargin, data);
  }
  static async deserialize(data, parent, uiManager) {
    let initialData = null;
  ...
  createDrawingOptions(_ref) {
    ...
    this._drawingOptions = InkEditor.getDefaultDrawingOptions({
      stroke: _util.Util.makeHexColor(...color),
  ...
  serialize() {
    ...
    const serialized = {
      annotationType: _util.AnnotationEditorType.INK,
      color: _editor.AnnotationEditor._colorManager.convert(stroke),
      opacity,
      thickness,
      paths: {
        lines,
...
exports.DrawingOptions = exports.DrawingEditor = void 0;
__w_pdfjs_require__(84);
__w_pdfjs_require__(150);
__w_pdfjs_require__(161);
__w_pdfjs_require__(164);
...
class DrawingEditor extends _editor.AnnotationEditor {
  #drawOutlines = null;
  #mustBeCommitted;
  _drawId = null;
  ...
  static _endDraw(event) {
    ...
    if (this.supportMultipleDrawings) {
      ...
      parent.addCommands({
        ...
        mustExec: false,
        type: _util.AnnotationEditorParamsType.DRAW_STEP
      });
      return;
    }
  ...
  static endDrawing(isAborted) {
    ...
    parent.toggleDrawing(true);
    parent.cleanUndoStack(_util.AnnotationEditorParamsType.DRAW_STEP);
    if (!DrawingEditor.#currentDraw.isEmpty()) {
      const {
        pageDimensions: [pageWidth, pageHeight],
        scale
...
exports.DrawingEditor = DrawingEditor;
...
exports.InkDrawOutliner = exports.InkDrawOutline = void 0;
__w_pdfjs_require__(84);
__w_pdfjs_require__(88);
__w_pdfjs_require__(97);
__w_pdfjs_require__(98);
...
class InkDrawOutliner {
  ...
  #normalizePoint(x, y) {
    return _outline.Outline._normalizePoint(x, y, this.#parentWidth, this.#parentHeight, this.#rotation);
  }
  isEmpty() {
  ...
  add(x, y) {
    ...
    this.#line.push(..._outline.Outline.createBezierPoints(x1, y1, x2, y2, x, y));
    return {
      path: {
        d: this.toSVGPath()
      }
  ...
  toSVGPath() {
    const firstX = _outline.Outline.svgRound(this.#line[4]);
    const firstY = _outline.Outline.svgRound(this.#line[5]);
    if (this.#points.length === 2) {
    ...
    if (this.#points.length === 4) {
      const secondX = _outline.Outline.svgRound(this.#line[10]);
      const secondY = _outline.Outline.svgRound(this.#line[11]);
    ...
    for (let i = this.#lastIndex, ii = this.#line.length; i < ii; i += 6) {
      const [c1x, c1y, c2x, c2y, x, y] = this.#line.slice(i, i + 6).map(_outline.Outline.svgRound);
...
exports.InkDrawOutliner = InkDrawOutliner;
class InkDrawOutline extends _outline.Outline {
  #bbox;
  #currentRotation = 0;
  #innerMargin;
  #lines;
  ...
  toSVGPath() {
    ...
    for (const {
      ...
      buffer.push(`M${_outline.Outline.svgRound(line[4])} ${_outline.Outline.svgRound(line[5])}`);
      if (line.length === 6) {
        buffer.push("Z");
        continue;
      }
      if (line.length === 12) {
        buffer.push(`L${_outline.Outline.svgRound(line[10])} ${_outline.Outline.svgRound(line[11])}`);
        continue;
      }
      for (let i = 6, ii = line.length; i < ii; i += 6) {
        const [c1x, c1y, c2x, c2y, x, y] = line.subarray(i, i + 6).map(_outline.Outline.svgRound);
        buffer.push(`C${c1x} ${c1y} ${c2x} ${c2y} ${x} ${y}`);
      }
    }
    return buffer.join("");
  ...
  serialize(_ref, isForCopying) {
    ...
    switch (this.#rotation) {
      case 0:
        rescaleFn = _outline.Outline._rescale;
        tx = pageX;
        ty = pageY + pageHeight;
        sx = pageWidth;
        sy = -pageHeight;
        ...
        break;
      case 90:
        rescaleFn = _outline.Outline._rescaleAndSwap;
        tx = pageX;
        ty = pageY;
        sx = pageWidth;
        sy = pageHeight;
    ...
    if (!lines) {
      ...
      for (const point of points) {
        ...
        for (let i = 4; i < len; i += 2) {
          const x = point[i];
          const y = point[i + 1];
          line.set(_outline.Outline.createBezierPoints(x1, y1, x2, y2, x, y), (i - 2) * 3);
  ...
  #getMarginComponents() {
    let thickness = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.#thickness;
  ...
  #computeBbox() {
    ...
    for (const {
      ...
      for (let i = 6, ii = line.length; i < ii; i += 6) {
        ...
        _util.Util.bezierBoundingBox(lastX, lastY, c1x, c1y, c2x, c2y, x, y, bbox);
        lastX = x;
        lastY = y;
      }
    }
  ...
  get viewBox() {
    return this.#bbox.map(_outline.Outline.svgRound).join(" ");
  }
  get defaultProperties() {
    ...
    return {
      ...
      path: {
        "transform-origin": `${_outline.Outline.svgRound(x)} ${_outline.Outline.svgRound(y)}`
      }
    };
  }
  get rotationTransform() {
    ...
    return `matrix(${a} ${b} ${c} ${d} ${_outline.Outline.svgRound(e)} ${_outline.Outline.svgRound(f)})`;
  }
  getPathResizingSVGProperties(_ref4) {
    let [newX, newY, newWidth, newHeight] = _ref4;
    const [marginX, marginY] = this.#getMarginComponents();
    const [x, y, width, height] = this.#bbox;
    if (Math.abs(width - marginX) <= _outline.Outline.PRECISION || Math.abs(height - marginY) <= _outline.Outline.PRECISION) {
      const tx = newX + newWidth / 2 - (x + width / 2);
      const ty = newY + newHeight / 2 - (y + height / 2);
      return {
        path: {
          "transform-origin": `${_outline.Outline.svgRound(newX)} ${_outline.Outline.svgRound(newY)}`,
    ...
    return {
      path: {
        "transform-origin": `${_outline.Outline.svgRound(x)} ${_outline.Outline.svgRound(y)}`,
        transform: `${this.rotationTransform} scale(${s2x} ${s2y}) ` + `translate(${_outline.Outline.svgRound(marginX)} ${_outline.Outline.svgRound(marginY)}) scale(${s1x} ${s1y}) ` + `translate(${_outline.Outline.svgRound(-marginX)} ${_outline.Outline.svgRound(-marginY)})`
      }
    };
  }
  getPathResizedSVGProperties(_ref5) {
    ...
    if (Math.abs(width - marginX) <= _outline.Outline.PRECISION || Math.abs(height - marginY) <= _outline.Outline.PRECISION) {
      ...
      for (const {
        ...
        _outline.Outline._translate(line, tx, ty, line);
        _outline.Outline._translate(points, tx, ty, points);
      }
      return {
        root: {
          viewBox: this.viewBox
    ...
    if (s1x !== 1 || s1y !== 1 || tx !== 0 || ty !== 0) {
      for (const {
        ...
        _outline.Outline._rescale(line, tx, ty, s1x, s1y, line);
        _outline.Outline._rescale(points, tx, ty, s1x, s1y, points);
      }
    }
    return {
      root: {
  ...
  getPathTranslatedSVGProperties(_ref6, parentDimensions) {
    ...
    if (this.#parentWidth === newParentWidth && this.#parentHeight === newParentHeight) {
      ...
      for (const {
        ...
        _outline.Outline._rescale(line, tx, ty, sx, sy, line);
        _outline.Outline._rescale(points, tx, ty, sx, sy, points);
      }
      bbox[2] *= sx;
      bbox[3] *= sy;
    }
  ...
  get defaultSVGProperties() {
    ...
    return {
      ...
      path: {
        d: this.toSVGPath(),
        "transform-origin": `${_outline.Outline.svgRound(bbox[0])} ${_outline.Outline.svgRound(bbox[1])}`,
        transform: this.rotationTransform || null
      },
      bbox
    };
...
exports.InkDrawOutline = InkDrawOutline;
...
class StampEditor extends _editor.AnnotationEditor {
  ...
  copyCanvas(maxDataDimension, maxPreviewDimension) {
    ...
    const outputScale = new _display_utils.OutputScale();
  ...
  static async deserialize(data, parent, uiManager) {
    ...
    if (data instanceof _annotation_layer.StampAnnotationElement) {
      ...
      canvas.remove();
      const altText = (await parent._structTree.getAriaAttributes(`${_util.AnnotationPrefix}${id}`))?.get("aria-label") || "";
      initialData = data = {
...
class DrawLayer {
  ...
  static get _svgFactory() {
    return (0, _util.shadow)(this, "_svgFactory", new _svg_factory.DOMSVGFactory());
  }
...
Object.defineProperty(exports, "DOMSVGFactory", ({
  enumerable: true,
  get: function () {
    return _svg_factory.DOMSVGFactory;
  }
}));
Object.defineProperty(exports, "DrawLayer", ({
  enumerable: true,
  get: function () {
    return _draw_layer.DrawLayer;
  }
}));
...
Object.defineProperty(exports, "OutputScale", ({
  enumerable: true,
  get: function () {
    return _display_utils.OutputScale;
  }
}));
...
Object.defineProperty(exports, "TextLayer", ({
  enumerable: true,
  get: function () {
    return _text_layer.TextLayer;
  }
}));
Object.defineProperty(exports, "TouchManager", ({
  enumerable: true,
  get: function () {
    return _touch_manager.TouchManager;
  }
}));
...
Object.defineProperty(exports, "fetchData", ({
  enumerable: true,
  get: function () {
    return _display_utils.fetchData;
  }
}));
...
Object.defineProperty(exports, "stopEvent", ({
  enumerable: true,
  get: function () {
    return _display_utils.stopEvent;
  }
}));
...
var _display_utils = __w_pdfjs_require__(204);
var _annotation_editor_layer = __w_pdfjs_require__(236);
var _tools = __w_pdfjs_require__(192);
var _annotation_layer = __w_pdfjs_require__(238);
var _color_picker = __w_pdfjs_require__(249);
var _svg_factory = __w_pdfjs_require__(243);
var _draw_layer = __w_pdfjs_require__(254);
var _worker_options = __w_pdfjs_require__(225);
var _highlight = __w_pdfjs_require__(246);
var _text_layer = __w_pdfjs_require__(234);
var _touch_manager = __w_pdfjs_require__(207);
var _xfa_layer = __w_pdfjs_require__(244);
const pdfjsVersion = '4.10.39';
const pdfjsBuild = 'f9bea397f';
{
  globalThis.pdfjsTestingUtils = {
    HighlightOutliner: _highlight.HighlightOutliner
  };
}
})();
